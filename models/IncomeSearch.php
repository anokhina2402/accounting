...
class IncomeSearch extends Income
{
    ...
    {
        $query = Income::find()->select('id, SUM(sum) as sum, category');
    ...
    /**
     * Creates data provider instance with search query one category applied
     *
     * @param array $params
     *
     * @return ActiveDataProvider
    ...
    {
        $query = Income::find()->select('id, date, sum, category');
