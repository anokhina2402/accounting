...
$this->title = 'Incomes Category ' . $category;
?>
<div class="outgo-index">
    ...
    <p>
        ...
        <?= Html::a('Create Income', Yii::$app->getUrlManager()->createUrl(['income/create','category'=>$category]), ['class' => 'btn btn-success']) ?>
    </p>
    <?= GridView::widget([
                    ...
                    'buttons'=> [
                        'update'=>function ($url, $model) {
                            return Html::a( '<span class="glyphicon glyphicon-pencil"></span>',
                                Yii::$app->getUrlManager()->createUrl(['income/update','id'=>$model['id']]),
                                ['title' => Yii::t('yii', 'Update'), 'data-pjax' => '0']);
                        },
                        'delete'=>function ($url, $model) {
                            return Html::a( '<span class="glyphicon glyphicon-trash"></span>',
                                Yii::$app->getUrlManager()->createUrl(['income/delete','id'=>$model['id']]),
